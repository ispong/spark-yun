<template>
    <div v-if="!props.disabled" class="select-link-type">
        <el-button
    ...
    <div v-if="showDataSync" id="container" class="data-sync-body">
        <div class="source-table-container">
            <el-table
                v-if="formData.sourceDBType === 'API'"
                ref="sourceTableRef"
            ...
            >
                ...
                <el-table-column v-if="!props.disabled" label="" width="8px">
                        ...
                        <el-dropdown trigger="click">
                            ...
                            <template #dropdown>
                                <el-dropdown-menu>
                                    ...
                                    <el-dropdown-item @click="removeCode(scope)">删除</el-dropdown-item>
                                    <el-dropdown-item @click="editCode(scope.row)">转换</el-dropdown-item>
                                </el-dropdown-menu>
                            </template>
                        </el-dropdown>
                    </template>
        ...
        <div class="target-table-container">
            <el-table
                v-if="formData.targetDBType === 'API'"
                ref="targetTableRef"
...
function clickSelectLinkConnect(type: string) {
    ...
    if (['SameLine', 'SameName'].includes(type)) {
        ...
        const sourceRefreshPromise =
            props.formData.sourceDBType === 'API'
