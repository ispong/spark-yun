<template>
    ...
    <div id="containerOutput" v-loading="connectNodeLoading" class="data-sync-body">
...
function getConnect() {
    getLinkData()
    return {
        fromColumnList: getSourceTableColumn(),
        toColumnList: getTargetTableColumn(),
        columnMap: connectNodeList.value
    }
}

function setSourceTableColumn(tableData: Column[]) {
    sourceTableColumn.value = tableData
    // setContainer()
    nextTick(() => {
...
function setTargetTableColumn(tableData: Column[]) {
