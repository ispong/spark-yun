...
import { GetExcelTableColumnsCodes, GetTableColumnsByTableId } from '@/services/data-sync.service'
...
// 根据excel获取字段信息
function getTableColummListByExcel(params) {
    GetExcelTableColumnsCodes(params)
        .then((res: any) => {
