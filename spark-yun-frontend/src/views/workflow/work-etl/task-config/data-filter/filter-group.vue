        ...
        <template v-for="(item, index) in items" :key="index">
            ...
            <div v-if="item.groupFilter" class="filter-group-block" :style="getGroupStyle()">
                ...
                <div class="filter-group-actions">
                    <el-button link type="primary" size="small" @click="addConditionToGroup(item.groupFilter)">
                        + 条件
                    </el-button>
                    <el-button link type="primary" size="small" @click="addGroupToGroup(item.groupFilter)">
                        + 分组
                    </el-button>
                </div>
            </div>
            ...
            <div v-else class="filter-row">
                ...
                <template v-if="item.filterType === 'CONDITION_FILTER'">
                    ...
                    >
                        <el-input v-model="items[index].filterValue" clearable placeholder="值" />
                    </el-form-item>
                </template>
                <template v-else>
                    <el-form-item
