<template>
  <div class="options-container">
    ...
    <div
      class="btn-box"
      @click="optionsEvent('runWorkData')"
    >
    ...
    <div
      class="btn-box"
      @click="optionsEvent('terWorkData')"
    >
    ...
    <div
      class="btn-box"
      @click="optionsEvent('locationNode')"
    >
      <el-icon>
        <Position />
      </el-icon>
    ...
    <div
      class="btn-box"
      @click="optionsEvent('sortWorkList')"
    >
      <el-icon>
