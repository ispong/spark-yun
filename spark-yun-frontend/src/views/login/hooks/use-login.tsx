    ...
    return {
        renderLoginForm: () => (
            <div class="zqy-login__form-wrap">
                ...
                <el-button class="zqy-login__btn" type="primary" loading={btnLoading.value} onClick={handleLogin}>
                    确认登录
                </el-button>
                {oauthLoaded.value && !!oauthUrlList.value.length && (
                            ...
                            v-slots={{
                                ...
                                default: () => (
                                    <div class="oauth-redirect-url">
                                        {oauthUrlList.value.map((item) => (
                                            <el-button type="primary" onClick={() => handleRedirect(item)}>
                                                {item.name}
                                            </el-button>
                                        ))}
                                    </div>
