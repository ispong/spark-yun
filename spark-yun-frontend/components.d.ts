...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    EllipsisTooltip: typeof import('./src/components/ellipsis-tooltip/ellipsis-tooltip.vue')['default']
...
// For TSX support
declare global {
  const BlockDrawer: typeof import('./src/components/block-drawer/index.vue')['default']
  const BlockModal: typeof import('./src/components/block-modal/index.vue')['default']
  const BlockTable: typeof import('./src/components/block-table/index.vue')['default']
  const CodeMirror: typeof import('./src/components/code-mirror/index.vue')['default']
  ...
  const EllipsisTooltip: typeof import('./src/components/ellipsis-tooltip/ellipsis-tooltip.vue')['default']
  ...
  const EmptyPage: typeof import('./src/components/empty-page/index.vue')['default']
  const Loading: typeof import('./src/components/loading/index.vue')['default']
  const LogContainer: typeof import('./src/components/log-container/index.vue')['default']
  const ParseModal: typeof import('./src/components/log-container/parse-modal/index.vue')['default']
  const RouterLink: typeof import('vue-router')['RouterLink']
  const RouterView: typeof import('vue-router')['RouterView']
  const ZqyLog: typeof import('./src/components/zqy-log/index.vue')['default']
  const ZStatusTag: typeof import('./src/components/z-status-tag/index.vue')['default']
  const ZSvgIcon: typeof import('./src/components/z-svg-icon/index.vue')['default']
}