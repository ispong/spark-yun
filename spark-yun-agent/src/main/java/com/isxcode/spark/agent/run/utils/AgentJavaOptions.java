...
public final class AgentJavaOptions {
    ...
    public static final List<String> SPARK_JAVA_17_MODULE_OPTIONS =
        Collections.unmodifiableList(Arrays.asList("--add-exports=java.base/sun.nio.ch=ALL-UNNAMED",
            "--add-exports=java.base/sun.security.action=ALL-UNNAMED", "--add-opens=java.base/java.lang=ALL-UNNAMED",
    ...
    public static final List<String> FLINK_JAVA_17_MODULE_OPTIONS =
        Collections.unmodifiableList(Arrays.asList("--add-exports=java.base/sun.net.util=ALL-UNNAMED",
