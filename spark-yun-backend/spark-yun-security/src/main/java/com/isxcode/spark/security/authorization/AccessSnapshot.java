...
public record AccessSnapshot(String userId,String tenantId,boolean systemAdmin,boolean platformAdmin,boolean tenantAdmin,boolean normalAdmin,boolean workspaceAllPermissions,Set<String>permissions){
