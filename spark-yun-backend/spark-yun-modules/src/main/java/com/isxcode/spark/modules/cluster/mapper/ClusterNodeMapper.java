package com.isxcode.spark.modules.cluster.mapper;

import com.isxcode.spark.api.cluster.dto.ScpFileEngineNodeDto;
import com.isxcode.spark.api.cluster.req.AddClusterNodeReq;
import com.isxcode.spark.api.cluster.req.UpdateClusterNodeReq;
...
public interface ClusterNodeMapper {
    ...
    @Mapping(target = "connectType", ignore = true)
