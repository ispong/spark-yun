...
@Data
@Entity
@SQLDelete(sql = "UPDATE sy_login_method_config SET deleted = 1 WHERE id = ? and version_number = ?")
@SQLRestriction("deleted = 0")
@Table(name = "sy_login_method_config")
@JsonIgnoreProperties({"hibernateLazyInitializer"})
@EntityListeners(AuditingEntityListener.class)
public class LoginMethodConfigEntity {
