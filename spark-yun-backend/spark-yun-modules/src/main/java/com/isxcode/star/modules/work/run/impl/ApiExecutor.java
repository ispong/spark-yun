...
// throw new WorkRunException(LocalDateTime.now() + WorkLog.ERROR_INFO + "检测作业失败 :
// 接口调用作业请求方式仅支持POST/GET \n");
// }
// // 检测接口url是否为空
...
//
// if (ApiType.GET.equals(apiWorkConfig.getRequestType())) {
// response = HttpUtils.doGet(apiWorkConfig.getRequestUrl(), requestParam, requestHeader,
// Object.class);
// }
